...
$result_usuario = "SELECT * FROM solicitacao_saques WHERE id AND status=0 ORDER BY id DESC LIMIT $inicio, $qnt_result_pg";
         ...
         <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-money"></i> Listar Saques Pendentes</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              <table class="table table-hover">
                ...
                ?>
                <tr>
                  <td class="text-center"><?=ver_data($data['data_hora']);?></td>
...
<?php
	...
	$result_pg = "SELECT COUNT(id) AS num_result FROM solicitacao_saques  WHERE status=0";
