...
<head>
      ...
      <style>
        /* Estilo do loader com tema de cassino */
        body.loading {
            background: linear-gradient(to right, #1e0f68, #3c1c7e), url('https://demo.seusistemabet.com/uploads/182281864864.png'); /* Gradiente roxo e imagem de fundo */
            background-size: cover; /* Cobrir toda a área do elemento pai */
            background-position: center; /* Centralizar a imagem de fundo */
            color: #ffdd57; /* Cor amarela para texto brilhante */
        }

        #loader {
            border: 10px solid #0003c6; /* Cor roxa para um visual de cassino */
            border-top: 10px solid #ffffff; /* Cor amarela para contraste */
            border-radius: 50%;
            width: 80px;
            height: 80px;
            ...
            top: 50%;
            left: 50%;
            margin-top: -40px; /* Metade da altura do loader */
            margin-left: -40px; /* Metade da largura do loader */
      ...
      <section id="page-wrapper" class="page-wrapper">
         ...
         <nav id="menu" class="content-navbar">
            <div class="navbar_wrapper">
               ...
               <script>
        // Simula um carregamento demorado (você pode substituir isso pelo seu código PHP)
        setTimeout(function(){
          ...
          <a open-support-btn="disable" href="https://t.me/seusistemabet_oficial" class="btn-small btn-color-2 w-button" data-toggle="" data-target="#suporteModal">Suporte</a>
