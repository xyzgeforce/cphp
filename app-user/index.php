...
<div class="main-content home">
   <div class="container-medium">
      ...
      <div class="col-md-12 mt-3 mb-3">    
          <div class="alert alert-success" role="alert" id="sessionDiv">Bem Vindo <?=$_SESSION['data_user']['nome'];?>! Você já pode se começar a jogar!</div>
      </div>
      <?php  $_SESSION['LOGGED'] = 'IS_LOGGED'; } ?>
      ...
      <div class="main-sublinks-wrapper">
         <div class="eng-sublinks-2">
            <a href="<?=$painel_afiliado_aovivo;?>" class="sublink w-inline-block" data-ix="hover-stroke-sublink">
            ...
            <a href="<?=$painel_afiliado_cassino;?>" class="sublink w-inline-block" data-ix="hover-stroke-sublink">
               <div class="eng-stroke-icon-sublink mb-8">
                  <div class="eng-icon-sublink">
                     <div class="icon-20"></div>
                  </div>
     ...
     <div class="eng-text-field-2 mb-16">
         <input type="text" class="input w-input" maxlength="256" data-name="Field-01" placeholder="Pesquisar" id="search" name="search">
         ...
         if (query.length > 2) {
               $.ajax({
                  ...
                  success: function(data){
                     ...
                     if ($('#result-games:contains("Nenhum game foi encontrado")').length) {
