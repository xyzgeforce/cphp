<?php
   ...
   if (isset($_POST['valor']) && isset($_POST['cpf']) && isset($_SESSION['data_user'])) {
        ...
        if( $valor > $saldoapi_fiverscan){
            echo '<div class="alert alert-danger" role="alert"><i class="fa fa-info-circle"></i>  Não é possível gerar depósitos nesse momento tente mais tarde!</div>';
        }else{
            echo criarQrCode($valor,$cpf,0);
        } 
    }
